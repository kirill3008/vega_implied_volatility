...
Архипов Кирилл Иванович 524 группа ВМК
...
- **libsimdjson-dev** - высокоскоростной парсер JSON файлов
  - Установка: `sudo apt-get install libsimdjson-dev`

### Дополнительные зависимости (для тестирования и бенчмаркинга):
- GoogleTest (для модульных тестов)
- Google Benchmark (для бенчмарков производительности)

Проект минимально зависим от внешних библиотек и использует только системно установленный simdjson для JSON парсинга.
